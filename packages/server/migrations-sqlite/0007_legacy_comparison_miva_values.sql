...
-- See legacyCompare.ts's mivaValuesFrom. Stored as JSON TEXT, same
-- convention as our_values/legacy_values in 0006.
ALTER TABLE legacy_comparison_rows ADD COLUMN miva_values TEXT;
