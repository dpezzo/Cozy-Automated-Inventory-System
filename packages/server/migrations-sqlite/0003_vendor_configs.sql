...
--                   column_mapping (JSON), parsed generically.
...
--
-- brand_allowlist and column_mapping are JSON arrays/objects stored as TEXT,
-- the same convention already used for reconciliation_rows.warning_codes /
-- blocker_codes in 0001_init.sql.
--
...
VALUES
  ('olliix', 'Olliix', 6, 'America/New_York', '["Beautyrest","Serta","True North by Sleep Philosophy","Woolrich","Sharper Image"]', 'upc-to-gtin', 'MISSING_FROM_OLLIIX', 'custom'),
  ('kh', 'K&H Pet Products', 3, 'America/New_York', '["K&H Pet Products"]', 'upc-to-gtin', NULL, 'custom'),
  ('gobi', 'Gobi Heat', 6, 'America/New_York', '["Gobi Heat"]', 'sku-to-mpn', NULL, 'custom'),
  ('fieldsheer', 'FieldSheer/MobileWarming', 6, 'America/New_York', '["Mobile Warming"]', 'sku-to-mpn', NULL, 'custom');
